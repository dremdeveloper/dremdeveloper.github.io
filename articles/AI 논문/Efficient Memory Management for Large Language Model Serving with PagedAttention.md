...
![Figure 1. LLM serving에서 GPU 메모리 구성과 처리량-배치 크기 관계를 보여주는 도식.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_01_memory_layout_and_throughput_curve.png)
...
![Figure 2. 기존 시스템에서 KV cache 메모리 낭비 비중을 분해한 그림.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_02_kv_cache_memory_waste_breakdown.png)
...
![Figure 3. 기존 연속 메모리 기반 KV cache 할당에서 발생하는 단편화 예시.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_03_existing_systems_kv_cache_fragmentation.png)
...
![Figure 4. vLLM 시스템 전체 구조 개요.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_04_vllm_system_overview.png)
...
![Figure 5. PagedAttention이 비연속 physical KV block을 참조하는 방식.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_05_pagedattention_non_contiguous_kv_blocks.png)
...
![Figure 6. vLLM의 block table 기반 디코딩 과정을 단계별로 보여주는 그림.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_06_block_table_translation_in_vllm.png)
...
![Figure 7. 두 요청의 logical block이 shared physical KV 공간에 매핑되는 예시.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_07_two_requests_shared_physical_kv_space.png)
...
![Figure 8. 병렬 샘플링에서 prefix KV block을 공유하는 예시.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_08_parallel_sampling_example.png)
...
![Figure 9. beam search에서 후보 시퀀스가 KV block을 공유하는 예시.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_09_beam_search_example.png)
...
![Figure 10. 기계번역 workload에서 shared prompt prefix를 재사용하는 예시.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_10_shared_prompt_example_for_machine_translation.png)
...
![Table 1. 평가에 사용한 모델 크기와 서버 구성.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_table_01_model_sizes_and_server_configurations.png)
...
![Figure 11. ShareGPT와 Alpaca의 입력/출력 길이 분포.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_11_sharegpt_and_alpaca_length_distributions.png)
...
![Figure 12. ShareGPT와 Alpaca에서 단일 시퀀스 생성 성능 비교.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_12_single_sequence_generation_sharegpt_alpaca.png)
...
![Figure 13. OPT-13B에서 시스템별 평균 배치 요청 수 비교.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_13_average_batched_requests_opt13b.png)
...
![Figure 14. OPT-13B Alpaca에서 병렬 샘플링과 beam search 성능 비교.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_14_parallel_generation_and_beam_search_opt13b_alpaca.png)
...
![Figure 15. shared KV block으로 절감되는 메모리 비율.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_15_memory_saving_from_shared_kv_blocks.png)
...
![Figure 16. shared prefix 번역 workload에서의 처리량 비교.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_16_shared_prefix_translation_workload.png)
...
![Figure 17. 챗봇 workload에서의 시스템 성능 비교.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_17_chatbot_workload_performance.png)
...
![Figure 18. kernel latency와 block size 영향을 분석한 ablation 결과.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_18_ablation_experiments.png)
...
![Figure 19. recomputation과 swapping의 비용 비교.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_19_recomputation_vs_swapping.png)
