...
![Figure 1. Memory layout and throughput curve.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_01_memory_layout_and_throughput_curve.png)
...
![Figure 2. KV cache memory waste breakdown.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_02_kv_cache_memory_waste_breakdown.png)
...
![Figure 3. Existing systems KV cache fragmentation.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_03_existing_systems_kv_cache_fragmentation.png)
...
![Figure 4. vLLM system overview.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_04_vllm_system_overview.png)
...
![Figure 5. PagedAttention with non-contiguous KV blocks.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_05_pagedattention_non_contiguous_kv_blocks.png)
...
![Figure 6. Block table translation in vLLM.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_06_block_table_translation_in_vllm.png)
...
![Figure 7. Two requests sharing physical KV space.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_07_two_requests_shared_physical_kv_space.png)
...
![Figure 8. Parallel sampling example.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_08_parallel_sampling_example.png)
...
![Figure 9. Beam search example.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_09_beam_search_example.png)
...
![Figure 10. Shared prompt example for machine translation.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_10_shared_prompt_example_for_machine_translation.png)
...
![Table 1. Model sizes and server configurations.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_table_01_model_sizes_and_server_configurations.png)
...
![Figure 11. ShareGPT and Alpaca length distributions.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_11_sharegpt_and_alpaca_length_distributions.png)
...
![Figure 12. Single-sequence generation on ShareGPT and Alpaca.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_12_single_sequence_generation_sharegpt_alpaca.png)
...
![Figure 13. Average batched requests for OPT-13B.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_13_average_batched_requests_opt13b.png)
...
![Figure 14. Parallel generation and beam search with OPT-13B on Alpaca.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_14_parallel_generation_and_beam_search_opt13b_alpaca.png)
...
![Figure 15. Memory saving from shared KV blocks.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_15_memory_saving_from_shared_kv_blocks.png)
...
![Figure 16. Shared-prefix translation workload.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_16_shared_prefix_translation_workload.png)
...
![Figure 17. Chatbot workload performance.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_17_chatbot_workload_performance.png)
...
![Figure 18. Ablation experiments.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_18_ablation_experiments.png)
...
![Figure 19. Recomputation versus swapping.](../../assets/images/Efficient Memory Management for Large Language Model Serving with PagedAttention/vllm_figure_19_recomputation_vs_swapping.png)
