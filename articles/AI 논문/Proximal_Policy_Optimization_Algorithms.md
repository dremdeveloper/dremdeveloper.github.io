...
<figure>
  <img src="/assets/images/Proximal_Policy_Optimization_Algorithms/02_Figure_2.png" alt="Figure 2. Surrogate objectives along the policy update direction, showing the clipped objective as a lower bound." />
  <figcaption><strong>Figure 2.</strong> Surrogate objectives along the policy update direction, showing the clipped objective as a lower bound.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/Proximal_Policy_Optimization_Algorithms/03_Table_1.png" alt="Table 1. Comparison of different surrogate objectives on the MuJoCo benchmark." />
  <figcaption><strong>Table 1.</strong> Comparison of different surrogate objectives on the MuJoCo benchmark.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/Proximal_Policy_Optimization_Algorithms/04_Figure_3.png" alt="Figure 3. Learning curves comparing PPO with other algorithms on continuous control tasks." />
  <figcaption><strong>Figure 3.</strong> Learning curves comparing PPO with other algorithms on continuous control tasks.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/Proximal_Policy_Optimization_Algorithms/05_Figure_4.png" alt="Figure 4. Learning curves for PPO on Roboschool humanoid locomotion and steering tasks." />
  <figcaption><strong>Figure 4.</strong> Learning curves for PPO on Roboschool humanoid locomotion and steering tasks.</figcaption>
</figure>

<figure>
  <img src="/assets/images/Proximal_Policy_Optimization_Algorithms/06_Figure_5.png" alt="Figure 5. Snapshot frames of learned humanoid behaviors under PPO." />
  <figcaption><strong>Figure 5.</strong> Snapshot frames of learned humanoid behaviors under PPO.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/Proximal_Policy_Optimization_Algorithms/12_Table_6.png" alt="Table 6. Mean final Atari performance after 40M frames for PPO, A2C, and ACER." />
  <figcaption><strong>Table 6.</strong> Mean final Atari performance after 40M frames for PPO, A2C, and ACER.</figcaption>
</figure>
