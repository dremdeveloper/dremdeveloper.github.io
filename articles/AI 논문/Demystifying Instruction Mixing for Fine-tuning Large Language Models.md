...
![Figure 1. P3와 Alpaca의 instruction 유형 분포.](/assets/images/article/demystifying_instruction_mixing_for_fine_tuning_large_language_models_figure_01_instruction_type_distribution_p3_alpaca.png)
...
![Table 1. NLP와 code generation benchmark 결과.](/assets/images/article/demystifying_instruction_mixing_for_fine_tuning_large_language_models_table_01_nlp_and_code_generation_results.png)

*Table 1. NLP와 code generation benchmark 결과. 모든 실험은 zero-shot 설정에서 수행되었고, 굵은 값은 최고 성능, 밑줄은 두 번째 성능을 뜻한다.*

![Figure 2. LLaMA-2-7B에서 mixing ratio와 데이터 수에 따른 NLP 및 code benchmark 변화.](/assets/images/article/demystifying_instruction_mixing_for_fine_tuning_large_language_models_figure_02_nlp_and_code_benchmark_scores.png)
...
![Table 2. alignment skill assessment 결과.](/assets/images/article/demystifying_instruction_mixing_for_fine_tuning_large_language_models_table_02_alignment_skill_assessment_results.png)
...
![Table 3. Alpaca, CodeAlpaca, P3의 예시.](/assets/images/article/demystifying_instruction_mixing_for_fine_tuning_large_language_models_table_03_instruction_type_examples.png)
...
![Figure 3. alignment skill assessment prompt.](/assets/images/article/demystifying_instruction_mixing_for_fine_tuning_large_language_models_figure_03_alignment_skill_assessment_prompt.png)
