...
이 용어집은 다음 계열의 문서에서 반복적으로 등장하는 표현을 중심으로 골랐습니다.

- Transformer와 attention 구조 설명 문서
- RLHF, PPO, DPO 같은 선호 정렬 문서
- Llama 2 같은 대규모 언어모델 학습/정렬 문서
- Mixture of Experts(MoE) 같은 대형 모델 구조 문서

필요하면 다음 단계로는 이 용어집을 바탕으로:

- **초급판 20개 핵심 용어 요약본**
- **중요 수식이 붙은 심화판 용어집**
- **영문 용어-한글 풀이-예시 문장 3열 버전**
