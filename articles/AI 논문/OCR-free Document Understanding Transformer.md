...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_01.png" alt="Figure 1. 전통적인 OCR 기반 문서 정보 추출 파이프라인." />
  <figcaption><strong>Figure 1.</strong> 전통적인 OCR 기반 문서 정보 추출 파이프라인.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_02.png" alt="Figure 2. OCR-dependent 파이프라인과 Donut의 OCR-free 파이프라인 비교." />
  <figcaption><strong>Figure 2.</strong> OCR-dependent 파이프라인과 Donut의 OCR-free 파이프라인 비교.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_03.png" alt="Figure 3. Donut의 단일 모델 기반 태스크 통합 구조." />
  <figcaption><strong>Figure 3.</strong> Donut의 단일 모델 기반 태스크 통합 구조.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_04.png" alt="Figure 4. SynthDoG가 생성한 다국어 합성 문서 샘플." />
  <figcaption><strong>Figure 4.</strong> SynthDoG가 생성한 다국어 합성 문서 샘플.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_05.png" alt="Figure 5. Donut 실험에 사용된 다운스트림 데이터셋 예시." />
  <figcaption><strong>Figure 5.</strong> Donut 실험에 사용된 다운스트림 데이터셋 예시.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Table_01.png" alt="Table 1. RVL-CDIP 문서 분류 성능 비교." />
  <figcaption><strong>Table 1.</strong> RVL-CDIP 문서 분류 성능 비교.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Table_02.png" alt="Table 2. 문서 정보 추출(IE) 데이터셋별 성능 비교." />
  <figcaption><strong>Table 2.</strong> 문서 정보 추출(IE) 데이터셋별 성능 비교.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Table_03.png" alt="Table 3. DocVQA 성능(전체/손글씨) 비교." />
  <figcaption><strong>Table 3.</strong> DocVQA 성능(전체/손글씨) 비교.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_06.png" alt="Figure 6. DocVQA 정성 비교 예시와 Donut의 장단점." />
  <figcaption><strong>Figure 6.</strong> DocVQA 정성 비교 예시와 Donut의 장단점.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_07.png" alt="Figure 7. 사전학습 전략·백본·해상도에 대한 추가 분석." />
  <figcaption><strong>Figure 7.</strong> 사전학습 전략·백본·해상도에 대한 추가 분석.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_08.png" alt="Figure 8. Donut 디코더 cross-attention 기반 텍스트 위치화 시각화." />
  <figcaption><strong>Figure 8.</strong> Donut 디코더 cross-attention 기반 텍스트 위치화 시각화.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_09.png" alt="Figure 9. OCR 엔진 선택 영향 및 저자원 학습 분석." />
  <figcaption><strong>Figure 9.</strong> OCR 엔진 선택 영향 및 저자원 학습 분석.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_A.png" alt="Figure A. SynthDoG 다국어 합성 문서 추가 예시." />
  <figcaption><strong>Figure A.</strong> SynthDoG 다국어 합성 문서 추가 예시.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_B.png" alt="Figure B. Ticket 데이터셋 예측 결과 예시." />
  <figcaption><strong>Figure B.</strong> Ticket 데이터셋 예측 결과 예시.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_C.png" alt="Figure C. CORD 데이터셋 예측 결과 예시." />
  <figcaption><strong>Figure C.</strong> CORD 데이터셋 예측 결과 예시.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_D.png" alt="Figure D. 비공개 서비스 데이터셋의 유사 샘플 예시." />
  <figcaption><strong>Figure D.</strong> 비공개 서비스 데이터셋의 유사 샘플 예시.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/OCR-free Document Understanding Transformer/OCR_free_Document_Understanding_Transformer_Figure_E.png" alt="Figure E. Donut의 teacher forcing 학습과 추론 과정." />
  <figcaption><strong>Figure E.</strong> Donut의 teacher forcing 학습과 추론 과정.</figcaption>
</figure>
