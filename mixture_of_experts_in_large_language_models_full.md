...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_01_moe_evolution_timeline.png" alt="Figure 1. Mixture of Experts(MoE) 모델 발전 타임라인." />
  <figcaption><strong>Figure 1.</strong> Mixture of Experts(MoE) 모델 발전 타임라인.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_table_01_representative_moe_architectures.png" alt="Table 1. 여섯 개 응용 도메인에 걸친 대표적 MoE 아키텍처 분류." />
  <figcaption><strong>Table 1.</strong> 여섯 개 응용 도메인에 걸친 대표적 MoE 아키텍처 분류.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_02_moe_taxonomy.png" alt="Figure 2. Mixture of Experts(MoE) 모델의 종합 taxonomy." />
  <figcaption><strong>Figure 2.</strong> Mixture of Experts(MoE) 모델의 종합 taxonomy.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_03_decoder_only_transformer_sparsely_gated_moe.png" alt="Figure 3. decoder-only Transformer에서 sparsely gated MoE가 어떻게 들어가는지 보여주는 예시." />
  <figcaption><strong>Figure 3.</strong> decoder-only Transformer에서 sparsely gated MoE가 어떻게 들어가는지 보여주는 예시.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_04_token_choice_vs_expert_choice_routing.png" alt="Figure 4. Token Choice와 Expert Choice MoE 라우팅 전략 비교." />
  <figcaption><strong>Figure 4.</strong> Token Choice와 Expert Choice MoE 라우팅 전략 비교.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_05_standard_moe_vs_mixer.png" alt="Figure 5. standard MoE와 MixER layer의 아키텍처 비교." />
  <figcaption><strong>Figure 5.</strong> standard MoE와 MixER layer의 아키텍처 비교.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_06_aesm2_multitask_architecture.png" alt="Figure 6. multi-task learning을 위한 AESM2 아키텍처." />
  <figcaption><strong>Figure 6.</strong> multi-task learning을 위한 AESM2 아키텍처.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_07_t_rex2_framework.png" alt="Figure 7. T-Rex2 프레임워크의 구조 개요." />
  <figcaption><strong>Figure 7.</strong> T-Rex2 프레임워크의 구조 개요.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_08_embodied_ai_in_healthcare.png" alt="Figure 8. healthcare에서 embodied AI가 적용되는 예시." />
  <figcaption><strong>Figure 8.</strong> healthcare에서 embodied AI가 적용되는 예시.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/mixture_of_experts_in_large_language_models/mixture_of_experts_in_large_language_models_figure_09_moe_cap_framework.png" alt="Figure 9. MoE-CAP 방법론 프레임워크." />
  <figcaption><strong>Figure 9.</strong> MoE-CAP 방법론 프레임워크.</figcaption>
</figure>
